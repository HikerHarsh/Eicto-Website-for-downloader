      ...
      <section className="hero">
          <div className="container hero-container">
              <div className="hero-text fade-in-up">
                  ...
                  <div className="hero-cta" id="download" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
                      <div style={{ display: 'flex', gap: '15px', flexWrap: 'nowrap', justifyContent: 'center', alignItems: 'flex-start' }}>
                          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                              <a 
                                  href="https://github.com/HikerHarsh/Eicto-release/releases/download/v1.0.0-beta/EictoSetup_v1.0.0.exe" 
                                  className="btn btn-primary btn-large" 
                                  target="_blank" 
                                  rel="noopener noreferrer"
                                  onClick={() => {
                                      if (typeof window !== 'undefined' && (window as any).triggerDownloadIncrement) {
                                          (window as any).triggerDownloadIncrement();
                                      }
                                  }}
                              >
                          ...
                          <Link href="/issues" className="btn btn-primary btn-large" style={{ background: 'rgba(255,255,255,0.05)' }}>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                              Community Issues
                          </Link>
                      </div>
