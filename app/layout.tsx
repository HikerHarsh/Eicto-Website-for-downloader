          ...
          <div className="container header-content">
            ...
            <nav className="nav" id="main-nav">
              <ul className="nav-list">
                ...
                <li><a href="https://drive.google.com/uc?export=download&id=1RPCOq-9jIlEbpY5vGGdI0RDmBjxyUNd4" className="btn btn-nav" target="_blank" rel="noopener noreferrer">Download Now</a></li>
              </ul>
            </nav>
